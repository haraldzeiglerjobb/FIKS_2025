...
# Interaktiv del
startmengde = float(input("Skriv inn startmengde jod-131 i mikrogram: "))
halveringstid = float(input("Skriv inn halveringstid i dager: "))
dager = float(input("Skriv inn antall dager som har gått: "))
